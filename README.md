...
This repository [Human-Activity-Recognition-Using-Smartphones](https://github.com/jvario/Human-Activity-Recognition-using-RNNs-in-Smartphones) includes 1 main directory and 3 general files:
...
The below table represents the evaluation results for each model, note that the models were trained with 7,352 samples and 9 features and evaluated with 2,947 samples.
